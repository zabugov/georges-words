...
🚧 **Pre-build.** Research and scaffolding phase. See [`docs/research/`](docs/research/) for the deep-dive on commercial Flow, local speech-to-text models, and the competitive landscape that informs the design.
...
georges-words/
├── docs/
│   ├── research/        # commercial Flow + local STT deep-dive (generated report)
