...
- **1.4** ~~Streaming transcription~~ — **obsolete**: it existed to hide multi-second transcription, and Parakeet does full utterances in 0.2 s. Building it (FluidAudio `SlidingWindowAsrManager`, chunk stitching, word-revision handling) would be days of work to save a fifth of a second.
...
- [ ] **5.1 (S)** **App icon** (menu bar + app bundle).
